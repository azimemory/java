...
public class Coffee {
	...
	private int addSafetyStock(Account account) {
		...
		int expencesPrice = addStock(needCnt, preExpencesPrice, account);
		account.registerExpences(expencesPrice);
	...
	private int addStock(int needCnt, int expencesPrice, Account account) {
